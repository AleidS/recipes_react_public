    ...
    return (
        <div className={styles.about}>
            ...
            <p>
                ...
                and as a web design demonstration.
                Hence, don't focus too much on the recipes themselves,
                they are just ones that I could find free pictures for. (Would not recommend this diet.)
            ...
            <p>
                ...
                You can find more of my websites and a more information <a href="http://www.aleidsuzan.com/portfolio">here </a>
            </p>
            ...
            <p>
                ...
                <span> For any questions , comments or feedback (always greatly appreciated), <a href="mailto:aleidoonk@gmail.com">send me an email</a>.<br />
                    Working on your own React/front-end project and need specific help? I'm happy to take a quick look.
                </span>
            ...
            <p>
                ...
                You can find the source code <a href="https://github.com/aleidS" target="_blank">here</a>

                <h4>Making of</h4>

                This website was coded from scratch, using Visual Studio Code. Combined with learning React, it took around 2 months to make as a side-project (Summer 2022)
                I refactored/cleaned up the code in Feb. 2024, in one day.

                <h4>React</h4>

                This website uses React to render components (like the recipe cards on the front page, as well as the recipes themselves),
                based on the contents of a local database with recipes.
                <br />
                <br />For those unfamiliar with React:
                ...
                This makes it much easier to add new recipes, and to keep an overview of the code.
                <br />
                <br />
                ...
                (broswerstack=expensive as a hobbyist, but I'd use that if I could)

                <h4>Clean code</h4>

                I used functions to avoid repetition, wherever possible.
