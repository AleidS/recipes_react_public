...
export default [
...

    {
        ...
        Image: 'pizza2.jpg',
        IntendedPeople: 3,
        RecipeSource: "https://www.homecookingadventure.com/homemade-pizza/",
        Table: [
            {
                Title: 'Dough',
                Ingredients: [
            ...
            },
            {
                ...
                Instruction: "Divide the dough into equal pieces, and stretch out dough from the center, not flattening the edges of your pizza. (with cornstarch or flour on a clean surface), cover with sauce, mozerella, and other toppings you like, then bake on 260°C for ~ 9 minutes"
            },
    ...
    },
    {
        ...
        url: 'homemade_tortilla_wraps',
        vegan: true,
        Image: 'tortilla2.jpg',
        ImageSource: 'https://pixabay.com/photos/maiz-tortilla-food-mexican-mexico-5135234/',
        IntendedPeople: 3,
        Table: [
            {
                Ingredients: [
